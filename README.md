...
running command...
$ automation (--version)
@choiceopen/automation-plugin-cli/0.0.1-0 darwin-arm64 node-v24.12.0
...
_See code: [src/commands/auth/login.ts](https://github.com/choice-open/automation-plugin-cli/blob/v0.0.1-0/src/commands/auth/login.ts)_
